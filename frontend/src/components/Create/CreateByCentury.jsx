...
const CreateByCentury = () => {
  ...
  return (
    ...
    <h2 className="text-4xl font-bold text-gray-600">Create Artifact By Century</h2>
    ...
    <div className="grid gap-2 mb-6 md:grid-cols-2">
       ...
       <div>
            <label htmlFor="byCentury" className="block my-4 text-base font-semibold text-slate-600">Century</label>
            <input
                type="number"
                id='byCentury'
                name='byCentury'
                {...register("byCentury")}
                className="border text-gray-800 text-base rounded-lg block w-full p-2.5 dark:placeholder-gray-400" placeholder="Ex. 20 or 19"  />
                <p className="mt-1 text-xs font-normal text-right text-gray-600">Only 2 digit number</p>
        </div>  
...
export default CreateByCentury