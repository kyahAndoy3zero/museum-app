...
const CreateByYearAround = () => {
  ...
  return (
     <div className="my-12 px-52">
        <h2 className="text-4xl font-bold text-gray-600">Create Artifact By Year Around</h2>
        ...
        <div className="grid gap-2 mb-6 md:grid-cols-2">
           ...
           <div>
                <label htmlFor="byYearAround" className="block my-4 mb-2 text-base font-semibold text-slate-600">Year Around</label>
                <input
                    type="number"
                    id='byYearAround'
                    name='byYearAround'
                    {...register("byYearAround")}
                    className="border text-gray-800 text-base rounded-lg block w-full p-2.5 dark:placeholder-gray-400" placeholder="Ex. 1980"  />
...
export default CreateByYearAround