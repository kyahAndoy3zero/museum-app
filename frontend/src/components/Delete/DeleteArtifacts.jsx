...
import {useDeleteArtifactMutation} from '../../feature/api/artifact-api/useArtifactQuery'

function DeleteArtifacts({ artifactId, onClose }) {
    
    const navigate = useNavigate()
    const deleteArtifact = useDeleteArtifactMutation();


    const deleteArtifactId = () => {
    ...
    return (
        <>
            ...
            <div className="p-6 text-center ">
                ...
                <h3 className="mb-5 text-lg font-normal text-gray-500 dark:text-gray-400">Are you sure you want to delete this artifact?</h3>
                <button onClick={deleteArtifactId} type="button" className="text-white bg-red-600 hover:bg-red-800 focus:ring-4 focus:outline-none focus:ring-red-300 dark:focus:ring-red-800 font-medium rounded-lg text-sm inline-flex items-center px-5 py-2.5 text-center mr-2">
                    Yes, I'm sure
                </button>
...
export default DeleteArtifacts